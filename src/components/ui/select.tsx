  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={mergeClassNames(
        'border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 text-sm outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className="pointer-events-none size-4 shrink-0 opacity-50" aria-hidden="true" />
